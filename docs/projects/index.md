...
Projects are active work streams that generate observations, data, failures, decisions and practical experience.

They feed the rest of the site:
...
Each project should produce useful records for:
